...
def acquisition_position(filename):
    ...
    aq_delay = 5
    print("Setting Max distance for reaching in %f seconds" % aq_delay)
    ...
    if len(frame.hands) == 2:
        for hand in Hands:
            if Hands.leftmost == hand:
                hand_left_position = [hand.palm_position.x / 1000, hand.palm_position.y / 1000,
                                      ...
                                      1]  # hand.palm_position gives the position in millimiters
            else:
        ...
        message_output = "Left and right hand extended positions have been recorded"
